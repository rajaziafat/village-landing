  ...
  andhrapradesh: [
    {
      ...
      images: [
        ...
        "./Assets/alikam/img (1).jpg",
        "./Assets/alikam/img (3).webp",
        "./Assets/alikam/img (4).webp",
        "./Assets/alikam/img (7).webp",
        "./Assets/alikam/img (8).webp",
        "./Assets/alikam/img (9).webp",
        "./Assets/alikam/img (10).webp",
        "./Assets/alikam/img (11).webp",
        "./Assets/alikam/img (12).webp",
        "./Assets/alikam/img (13).webp",
        "./Assets/alikam/img (14).webp",
        "./Assets/alikam/img (15).webp",
        "./Assets/alikam/img (16).webp",
        "./Assets/alikam/img (17).webp",
        "./Assets/alikam/img (18).webp",
        "./Assets/alikam/img (19).webp",
      ],
    },
  ],
  karnataka: [],
